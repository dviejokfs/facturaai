...
const defaultProps: AdCompositionProps = {
  spec: {
    ...
    script: {
      ...
      solution: 'FacturaAI conecta tu Gmail y ordena cada factura según llega.',
  ...
  country: {
    ...
    appLocale: 'es-ES',
    appStoreUrl: 'https://apps.apple.com/es/app/facturaai',
    landingUrl: 'https://facturaai.com/es',
    voices: {},
    avatars: {},
    brollLibrary: [],
    appDemoClip: '',
